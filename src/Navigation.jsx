...
const Navigation = (props) => {
    ...
    return (
        <div className={`bg-${mode}-600 text-${textcolor} flex justify-between items-center h-14 w-full px-4 shadow-lg`}>
            <nav className="flex justify-between items-center w-full">
                ...
                <div className="">
                    <label>
                        <input onClick={toggleMode} type="checkbox" className="rounded" /> <span>{btntext}</span>
                    </label>
                </div>
            </nav>
        </div>
